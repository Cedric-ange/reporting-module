...
with open('C:/Users/angec/feuil1_final_verification.txt', 'w', encoding='utf-8') as f:
    f.write("=== VERIFICATION OF FEUIL1 FINAL CORRECTION ===\n\n")
    ...
    for idx, row in date_sample.iterrows():
        f.write(f"  {row['Format']}: Personne touché={row['Personne touché (Client acheteur)']}, Affiche={row['Affiche']}\n")
...
print("Verification report created: feuil1_final_verification.txt")
